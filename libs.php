    ...
    // Validar el tipo de usuario y los privilegios
      switch ($_SESSION['Privs']) {
        ...
        case '4':
            ...
            echo '<li><a href="comunicacion.php">Comunicación</a></li>'."\n";
            echo '</li>'."\n";
            break;
...
function GrupoActivo($IdUsuario, $GrupoActivo) {
    ...
    if ($indice>0) {
        ...
        foreach($grupo as $contenido) {
            echo '<option value="'.$contenido['IdGrupo'].'"';
            if ($contenido['IdGrupo'] == $GrupoActivo) { echo ' selected'; }
            echo '>'.$contenido['IdGrupo'].'</option>'."\n";
        }
        echo '</select>'."\n";
        echo '</div>'."\n";
...
function grupos($IdUsuario) {
        echo '<form method="post" action="index.php">'."\n";
        echo '<div class="row gtr-uniform">'."\n";
        echo '<div id="ListaSeccion" name="ListaSeccion" class="col-3 col-12-small">'."\n";
        echo '<select id="seccion" name="seccion" onchange="showGrupos()">'."\n";
        ...
        echo '</select>'."\n";
        echo '</div>'."\n";
        echo '<div id="select1" name="select1" class="col-3 col-12-small">'."\n";
        echo '<select id="Active" name="Active"><option value="" disabled selected>Elige el Grupo</option></select>'."\n";
        echo '</div>'."\n";
        echo '<div id="select2" name="select2" class="col-3 col-12-small">'."\n";
        echo '</div>'."\n";
        echo '<div id="" name="select2" class="col-3 col-12-small">'."\n";
        echo '</div>'."\n";
        echo '<div class="col-12">'."\n";
        echo '<ul class="actions">'."\n";
        echo '<li><input type="submit" value="Activar " class="primary" /></li>'."\n";
        echo '</ul>'."\n";
        echo '</div>'."\n";
        echo '<input id="flag" name="flag" type="hidden" Value="1">';
        echo '</div>'."\n";
        echo '</form>'."\n";
}
...
function lista_circulares() {
    ...
    echo '<table>'."\n";
    echo '<tr><th>Seccion</th><th>Grupo</th><th>Descripción</th><th>Enlace</th></tr>'."\n";
    $conn = new Circular();
    if ($Grupo != '') {
